...
?>
<div class="rf-login-wrapper" dir="rtl"
    ...
    <div class="rf-login-card">
        ...
        <div id="rf-login-step-phone" class="rf-login-step">
            <div class="rf-input-group">
                ...
                <div class="rf-input-wrapper">
                    ...
                    <input type="tel" id="rf-login-phone" maxlength="11"
                           placeholder="<?php echo esc_attr( $t['phone_ph'] ); ?>"
            ...
            <div class="rf-login-divider">
                <span>یا</span>
            </div>
            <a href="#" id="rf-switch-password" class="rf-btn rf-btn-outline">
                <?php echo esc_html( $t['switch_password'] ); ?>
            </a>
            <?php endif; ?>
        ...
        <!-- Password Step -->
        <div id="rf-login-step-password" class="rf-login-step" style="<?php echo $loginMethods === 'password' ? '' : 'display:none;'; ?>">
            <div class="rf-input-group">
                ...
                <div class="rf-input-wrapper">
                    ...
                    <input type="tel" id="rf-login-phone-pw" maxlength="11"
                           placeholder="<?php echo esc_attr( $t['phone_ph'] ); ?>" dir="ltr">
                </div>
            </div>
            <div class="rf-input-group">
            ...
            <a href="#" id="rf-switch-otp" class="rf-btn rf-btn-outline">
                <?php echo esc_html( $t['switch_otp'] ); ?>
            </a>
            <?php endif; ?>
